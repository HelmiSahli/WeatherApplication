package summer.application.nice.weatherapplication;
...
/**
 * Created by Helmi on 18/08/2017.
 */
public class MainActivity extends AppCompatActivity {

    // we"ll make HTTP request to this URL to retrieve weather conditions
    String weatherWebserviceURL = "http://api.openweathermap.org/data/2.5/weather?q=nice,fr&appid=2156e2dd5b92590ab69c0ae1b2d24586&units=metric";
    //the loading Dialog
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        if (jsonObj.getString("main").equals("Clouds")) {
                            backgroundImage = "https://i2.cdn.cnn.com/cnnnext/dam/assets/160715100714-nice-beach-promenade-des-anglais-exlarge-169.jpg";
                        } else if (jsonObj.getString("main").equals("Rain")) {
                            backgroundImage = "https://d2uqfpnktc64mn.cloudfront.net/uploads/ckeditor_assets/pictures/14435/content_c12-Image-by-Christophe-Jacrot.-Rauba-Capeu-_Nice_.-In-the-Mood-For-Rain.-Nice_-France.png";
                        } else if (jsonObj.getString("main").equals("Clear")) {
                            backgroundImage = "http://blog.parkinn.fr/wp-content/uploads/sites/4/2015/10/Promenade-des-Anglais-Nice.jpg";
                        }else if (jsonObj.getString("main").equals("Snow")) {
                            backgroundImage = "http://aliana.a.l.pic.centerblog.net/60ugvikh.jpg";
                        }
